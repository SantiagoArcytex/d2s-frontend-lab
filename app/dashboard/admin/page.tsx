    ...
    >
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          height: '64px', 
          borderRadius: '12px', 
          backgroundColor: 'var(--action-primary-light)', 
          display: 'flex', 
          alignItems: 'center', 
...
export default function AdminPortalPage() {
  const cards: AdminCardProps[] = [
    {
      icon: <CheckCircleIcon style={{ fontSize: '32px', color: 'var(--action-primary)' }} />,
      title: 'Review Deals',
    ...
    {
      icon: <PeopleIcon style={{ fontSize: '32px', color: 'var(--action-primary)' }} />,
  ...
  return (
    ...
    >
      ...
      <Text variant="body" style={{ color: 'var(--text-secondary)', marginBottom: '3rem' }}>
